      ...
      >
        ...
        >
          ...
          <InputLabel htmlFor="description-input" sx={{ mt: 2, width: "65%" }}>
            {t("Description of the Lost Item")} <span style={{ color: "red" }}>*</span>
          </InputLabel>
          ...
          <TextField
            ...
            multiline
            rows={4}
            placeholder={t("Mention details such as type, color, brand, size, place, any unique features, etc.")}
          ...
          <InputLabel htmlFor="resource-input" sx={{ mt: 2, width: "65%" }}>
            {t("How Did You Hear About Us?")} <span style={{ color: "red" }}>*</span>
          </InputLabel>
          <TextField
            required
            name="resource"
          ...
          <FormControlLabel
            ...
            label={t("I acknowledge that a service fee of 25 SAR applies if the item is found")}
          />
