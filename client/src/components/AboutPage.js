  ...
  const features = [
    {
      ...
      description: "Our advanced algorithm matches lost items with found reports using detailed descriptions and AI technology.",
    },
    {
      icon: <SpeedIcon sx={{ fontSize: 48, color: "primary.main" }} />,
      title: "Fast Response",
      description: "Get instant notifications when a potential match is found, helping you reunite with your items quickly.",
    },
    {
    ...
    },
    {
      ...
      description: "All users are verified to ensure a trustworthy community of helpers and seekers.",
    },
  ];
  ...
  const values = [
    {
      ...
      description: "We believe in the power of community helping each other find lost belongings.",
    },
    {
      icon: <TrendingUpIcon sx={{ fontSize: 40, color: "primary.main" }} />,
      title: "Continuous Innovation",
      description: "We constantly improve our platform to provide the best lost and found experience.",
    },
    {
      icon: <VerifiedUserIcon sx={{ fontSize: 40, color: "primary.main" }} />,
      title: "Trust & Transparency",
      description: "Building trust through transparent processes and verified user interactions.",
    },
  ];
            ...
            {[
              {
                ...
                description: "Fill out a detailed form about your lost or found item with description and photo.",
              },
              {
                step: "2",
                title: "We Match & Notify",
                description: "Our system automatically matches reports and sends instant notifications.",
              },
              {
                step: "3",
                title: "Connect & Reunite",
                description: "Connect with the finder or owner and arrange safe item return.",
              },
            ].map((step, index) => (
              <Grid item xs={12} md={4} key={index}>
                <motion.div
            ...
            >
              <Accordion
                ...
                sx={{
                  ...
                  border: "2px solid",
                  borderColor: expanded === `panel${index}` ? "primary.main" : "#e0e0e0",
